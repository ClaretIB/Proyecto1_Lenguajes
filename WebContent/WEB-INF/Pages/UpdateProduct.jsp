...
$.ajax({
	  ...
	  success: function(data){
        ...
        <div class="col-md-9">
        		...
        		<div class="row">
        			<div class="col-md-4">
        				<input type="text" class="form-control" id="productName" placeholder="Product Name" <a href="sale" class="list-group-item active">New Sale</a>
			<a href="newdish" class="list-group-item">New Dish</a>/>
        			</div>
        		</div><br>
        		<div class="row">
        		...
        		<div class="row">
        			<div class="col-md-4">
        				<input type="button" class="btn btn-success btn-block" id="btnInsert" value="Update" onclick="addProduct()"/>
        			</div>
        		</div>
        		</form>
        	</div>
	    	   ...
	    	   $.ajax({
	   	    	...
	   	    	success: function(result)
	   	    	{
	   	    		...
	   	    		$( data ).each(function( index, info ) {
	   	    			$("#productName").val(info.nombre)
	   	    			$("#price").val(info.precio)
	   	    			$("#quantity").val(info.cantidad)
	   	        	});
	   	    }});
			});
  </script>
