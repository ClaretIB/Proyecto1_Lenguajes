    ...
    <form method="POST">
     <div class="col-md-9">
        <div class="container-fluid">
        	...
        	<div class="row">
        	<div class="col-md-6">
  				<h2><span class="label label-info">NEW DISH</span></h2>
  				<select onchange="cargarPlato()" class="form-control" id="selectdishes">
    				
  				</select>
  				<br>
  				<br> <input class="form-control" id="price2" name="price" placeholder="Price Without Taxes"  /> <br>
			</div>
			</div>
			<div  class="row">
		  ...
		  <div  class="row">
				<div class="col-md-6"> 
				   <br><button type="button" class="btn btn-success btn-block" onclick="updateDish()">Update Dish</button>
				</div>
		  </div>
